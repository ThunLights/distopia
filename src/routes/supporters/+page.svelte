...
<Meta
	{title}
	description={["サポートサーバーに関する説明です。", "支援団体等が記載されています。"].join("")}
/>
...
<main>
	...
	<div class="contents">
		<div class="sections">
			<div class="section">
				<p class="title">支援団体って何をするの？</p>
				<div class="section-content">
					<p>新しい機能の事前テストやデバッグなどへの協力</p>
					<p>Distopiaの新バージョンリリース時にサーバーでの宣伝</p>
					<p>新機能の提案や既存機能の改善案の提出</p>
				</div>
			</div>
			<div class="section">
				<p class="title">どうやったら支援団体になれるの？</p>
				<div class="section-content">
					<p>
					...
					<p>
						支援団体になりたいサーバーがありましたら<a class="underline" href={DISCORD_INVITE_LINK}
							>公式Discordサーバー</a
						>にて問い合わせお願いします。
					</p>
				</div>
