...
export class StatChannelAllMembersSelectMenu extends ChannelSelectMenuInteractionBase {
  public override requireUserGuildPermissions: PermissionResolvable[] = ["Administrator"];
  public override customId: string = "statChannelAllMembersSelect";
  ...
  protected override async exec(
    ...
    await this.core.statChannel.assignChannel(guild.id, "statChannelAllMembers", options.channelId);
