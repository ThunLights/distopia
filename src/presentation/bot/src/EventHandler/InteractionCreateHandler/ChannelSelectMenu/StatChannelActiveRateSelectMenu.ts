...
export class StatChannelActiveRateSelectMenu extends ChannelSelectMenuInteractionBase {
  public override requireUserGuildPermissions: PermissionResolvable[] = ["Administrator"];
  public override customId: string = "statChannelActiveRateSelect";
  ...
  protected override async exec(
    ...
    await this.core.statChannel.assignChannel(guild.id, "statChannelActiveRate", options.channelId);
