...
export class StatChannelActiveRateResetButton extends ButtonInteractionBase {
  public override requireUserGuildPermissions: PermissionResolvable[] = ["Administrator"];
  public override customId: string = "statChannelActiveRateReset";
  ...
  protected override async exec(
    ...
    await this.core.guild.saveSetting({ guildId: guild.id, statChannelActiveRate: null });
