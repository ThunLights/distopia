...
export class StatChannelBotsResetButton extends ButtonInteractionBase {
  public override requireUserGuildPermissions: PermissionResolvable[] = ["Administrator"];
  public override customId: string = "statChannelBotsReset";
  ...
  protected override async exec(
    ...
    await this.core.guild.saveSetting({ guildId: guild.id, statChannelBots: null });
