...
const customIdPrefix = "blackListAutoBanOff:";

const BlackListIdSchema = z.coerce.number().int();

export class BlackListAutoBanOffButton extends ButtonInteractionBase {
  ...
  protected override async exec(
    ...
    await this.core.blackList.apply({ guildId: guild.id, blackListId, autoBan: false });
