...
export class BumpNoticeOffButton extends ButtonInteractionBase {
  public override requireUserGuildPermissions: PermissionResolvable[] = ["Administrator"];
  public override customId: string = "bumpNoticeOff";
  ...
  protected override async exec(
    ...
    await this.core.guild.saveSetting({ guildId: guild.id, bumpNotice: false });
