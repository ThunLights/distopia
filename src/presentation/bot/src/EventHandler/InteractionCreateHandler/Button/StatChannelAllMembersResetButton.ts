...
export class StatChannelAllMembersResetButton extends ButtonInteractionBase {
  public override requireUserGuildPermissions: PermissionResolvable[] = ["Administrator"];
  public override customId: string = "statChannelAllMembersReset";
  ...
  protected override async exec(
    ...
    await this.core.guild.saveSetting({ guildId: guild.id, statChannelAllMembers: null });
