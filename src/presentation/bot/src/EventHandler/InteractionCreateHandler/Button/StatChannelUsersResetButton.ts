...
export class StatChannelUsersResetButton extends ButtonInteractionBase {
  public override requireUserGuildPermissions: PermissionResolvable[] = ["Administrator"];
  public override customId: string = "statChannelUsersReset";
  ...
  protected override async exec(
    ...
    await this.core.guild.saveSetting({ guildId: guild.id, statChannelUsers: null });
